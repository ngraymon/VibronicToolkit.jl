...
if c[:pigs]
    ...
    println("Z_MC: $(sampling.Z) ± $(sampling.Z_err)")
    println("E_MC: $(sampling.E) ± $(sampling.E_err)")
    println("SvN_MC: $(sampling.SvN) ± $(sampling.SvN_err)")
    println("S2_MC: $(sampling.S2) ± $(sampling.S2_err)")
	println("beta: $(beta)")
    ...
    println("Z_MC: $(sampling.Z) ± $(sampling.Z_err)")
    println("E_MC: $(sampling.E) ± $(sampling.E_err)")
    println("Cv_MC: $(sampling.Cv) ± $(sampling.Cv_err)")
	println("beta: $(beta)")
	println("tau: $(beta / P)")
end
